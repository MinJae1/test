...
/**
 * File : AddrBook.java Desc : 주소록 프로그램 DO 클래스
 * 
...
public class AddrBook {
	...
	public String getAb_company() {
		return ab_company;
	}

	public void setAb_company(String ab_company) {
		this.ab_company = ab_company;
	}
