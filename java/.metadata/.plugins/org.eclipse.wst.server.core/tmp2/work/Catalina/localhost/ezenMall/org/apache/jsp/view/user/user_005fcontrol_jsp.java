 ...
 * Generated at: 2018-10-31 01:06:27 UTC
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
		...
		if (!pw.equals(pwcheck)) {
			...
			if (memdao.addMember(memdo)) {
				out.println("<script>alert('Join is Success. Login Please!');"
						+ " document.location.href = '../shop/shop_control.jsp?action=getall' </script>");
	...
	case "login":
		...
		if (memdao.login(memdo.getUid(), memdo.getPasswd())) {
			...
			response.sendRedirect("../shop/shop_control.jsp?action=getall");
		} else {
			out.println(
